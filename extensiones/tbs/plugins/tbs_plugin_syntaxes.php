...
// Direct command must be a string which is prefixed by the name of the class followed by a dot (.). The suffix is just unique ID for identifying the command.
define('TBS_THIS_COMMAND1','clsTbsThisPlugIn.command1');
define('TBS_THIS_COMMAND2','clsTbsThisPlugIn.command2');
...
class clsTbsThisPlugIn {
	...
	public $Version = '1.00'; // Versions of installed plug-ins can be displayed using [var..tbs_info] since TBS 3.2.0
	public $TBS; // will be set when the plug-in is installed on a TBS instance
